...
export function StepEducation({ data, onChange }: Props) {
  ...
  return (
    <div className="step-body">
      <h2>Taʼlim</h2>
      <p className="step-lead">Oliy yoki oʻrta maxsus taʼlim — yoʻq boʻlsa belgilang.</p>

      <label className="skip-row">
        <input type="checkbox" checked={data.noEducation} onChange={toggleNoEdu} />
        <span>
          <strong>Oʻqimaganman</strong>
          <em>Maxsus taʼlim olmaganman / hali bitirmaganman</em>
        </span>
      </label>
